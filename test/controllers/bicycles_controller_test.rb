...
class BicyclesControllerTest < ActionController::TestCase
  ...
  test "should create bicycle" do
    assert_difference('Bicycle.count') do
      post :create, bicycle: { brand: @bicycle.brand, category: @bicycle.category, description: @bicycle.description, image_url: @bicycle.image_url, name: @bicycle.name, price: @bicycle.price }
    end
  ...
  test "should update bicycle" do
    patch :update, id: @bicycle, bicycle: { brand: @bicycle.brand, category: @bicycle.category, description: @bicycle.description, image_url: @bicycle.image_url, name: @bicycle.name, price: @bicycle.price }
    assert_redirected_to bicycle_path(assigns(:bicycle))
  end
